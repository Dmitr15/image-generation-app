...
prompt = 'A cat with a hat, cute, adorable, disney, pixar, highly detailed, 8k'
...
def img2img():
    ...
    pipe = StableDiffusionImg2ImgPipeline.from_pretrained(MMIX_MODEL_PATH, torch_dtype=torch.float32).to('cpu')
    # pipe = pipe.to(device)
    #, use_safetensors=True
